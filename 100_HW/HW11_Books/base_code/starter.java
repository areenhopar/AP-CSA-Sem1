		...
		while(true){
			...
			switch (choice.trim().toLowerCase()) {
				...
				case "printback": 
					...
					break;
				case "printnum": 
					System.out.println("How many words of the text woud you like to print? ");
					printsNumber(arr, sc.nextInt());
					sc.nextLine();
					break;
				case "change":
					System.out.println("What is the file name of the new text? (Ex: shrek.txt)");
				...
				case "check":
					...
					System.out.println("There are " + checksArray(arr, target) + " many \'" + target + "\' in " + textFile + ".");
					break;
				case "common": 
	...
	*/
	public static void printsNumber(String[] arr, int num){
		if (num > arr.length || num < 0) {
			System.out.println("Number either too large or a negative. Please try again.");
			return;
		}
